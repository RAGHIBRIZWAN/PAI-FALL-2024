class Student:
    def __init__(self,name,nuId):
        self.name = name
        self.nuId = nuId
        
    def get_info(self):
        print(f"Student name is {self.name} having id {self.nuId}")
...
class Marks(Student):
    ...
    def CoursesMarks(self):
        a = int(input('Enter the number of courses you were enrolled: '))
        for i in range(a):
